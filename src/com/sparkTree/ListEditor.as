...
/**
 *  This class is based on the spark DataGridEditor
 *  The ListEditor contains all the logic and event handling needed to 
 *  manage the life cycle of an item editor. 
 *  A ListEditor is owned by a 
 *  specified List. The owning DataGrid is responsible for calling
